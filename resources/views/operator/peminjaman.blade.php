                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                                        <li><a href="{{url('operator/peminjamanOperator/updstatus/'.$row->id_peminjaman)}}">Sudah</a></li>
                                                    </ul>
                                                    @endif
                                                </div>
                                                {{-- @if($row->status_peminjaman == "sedang")
                                                <span class="label bg-red">{{$row->status_peminjaman}}</span>
                                                @else
                                                <span class="label bg-green">{{$row->status_peminjaman}}</span>
                                                @endif --}}
                                            </td>
                                        </tr>
                                        @endforeach
