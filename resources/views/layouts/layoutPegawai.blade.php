@if(session('pegawai')==null)
<script>
    window.location.href="{{url('loginPegawai')}}";
</script>
@else
<!DOCTYPE html>
<html>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="javascript:void(0);">{{session('pegawai')->nama_pegawai}}</a>
                                    </li>
                                    <li>
                                        <a href="{{url('logoutPegawai')}}">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{url('pegawai/peminjamanPegawai')}}">
